...
import ie.homesavers.warehousemanagement.webservices.stock_correction.StockCorrectionRequest;
import ie.homesavers.warehousemanagement.webservices.stock_correction.TemplItemStockDetail;
...
//        }
        ...
        if (id == R.id.save_stock_correction_save) {
            createStockCorrection();
        } else if (id == R.id.button_save_stock_correction_barcode_ok) {
            validationBarcodeText();
        } else if (id == R.id.text_adjustment_type) {
            showAdjustmentDia(0);
        }
// else if (id == R.id.edit_save_stock_correction_barcode) {
//     ((MainActivity) getActivity()).startScanActivity(editSaveStockCorrectionBarcode);
// }
