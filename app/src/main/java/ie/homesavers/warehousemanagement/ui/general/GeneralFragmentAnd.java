...
import ie.homesavers.warehousemanagement.webservices.general.DeleteGeneralModel;
import ie.homesavers.warehousemanagement.webservices.general.GeneralInputDetail;
import ie.homesavers.warehousemanagement.webservices.general.GeneralModel;
import ie.homesavers.warehousemanagement.webservices.general.GeneralRemarkModel;
import ie.homesavers.warehousemanagement.webservices.general.RequestGeneralList;
...
//        }
        ...
        if (id == R.id.button_general_ok) {
            if (!TextUtils.isEmpty(editTextBarcode.getText().toString())) {
                SearchStock();
            } else {
                Toast.makeText(getActivity(), "Please scan barcode !", Toast.LENGTH_SHORT).show();
            }
        } else if (id == R.id.button_general_submit) {
            validationSubmitGeneral();
        } else if (id == R.id.button_general_list) {
            getGeneralList();
            onGeneralListClicked();
        } else if (id == R.id.button_general_entry) {
            onGeneralEntryClicked();
        }
    }
