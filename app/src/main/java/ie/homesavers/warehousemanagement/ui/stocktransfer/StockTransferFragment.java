...
import ie.homesavers.warehousemanagement.webservices.save_stock_trans.RequestPickHeldStockTransfer;
...
//        }
        ...
        if (id == R.id.id_stock_transfer_fragment_create_stock_transfer_img) {
            onCreateStockTransferClicked();
        } else if (id == R.id.id_stock_transfer_fragment_pick_held_stock_transfer_img) {
            onPickHeldStockTransferClicked();
        } else if (id == R.id.button_create_stock_transfer_start_stock_transfer) {
            if (!TextUtils.isEmpty(selectCreateStockTransferBusinessLocation.getText()) &&
                    !TextUtils.isEmpty(selectCreateStockTransferToLocation.getText())) {
                onSaveStockTransferClicked();
            } else {
            ...
            // openSelectBusinessLocationDialog();
        } else if (id == R.id.edit_pick_held_stock_transfer_business_location) {
            // openSelectBusinessLocationDialog();
        } else if (id == R.id.select_create_stock_transfer_to_warehouse) {
            openSelectToWarehouseDialog();
        } else if (id == R.id.button_pick_held_stock_transfer_clear) {
            clearPickHeldStockTransferBusinessLocation();
        } else if (id == R.id.button_show_held_stock_transfer) {
            validationButtonShowHeldStockTransferList();
        }
